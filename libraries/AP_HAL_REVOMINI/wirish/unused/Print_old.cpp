...
void Print::write(const void *buffer, uint32_t size) {
    uint8_t *ch = (int8_t*)buffer;
    while (size--) {
        write(*ch++);
    }
}

void Print::print(int8_t b, int base) {
...
void Print::println(int8_t b, int base) {
    print(b, base);
    println();
}
...
void Print::printNumber(unsigned long long n, int8_t base) {
 ...
 */
void Print::printFloat(double number, int8_t digits) {
