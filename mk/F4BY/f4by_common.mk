...
ifneq ($(wildcard $(F4BY_ROOT)/src/systemcmds/reflect),)  
MODULES         += systemcmds/reflect
endif
ifneq ($(wildcard $(F4BY_ROOT)/src/systemcmds/motor_test),)  
MODULES         += systemcmds/motor_test
endif
ifneq ($(wildcard $(F4BY_ROOT)/src/systemcmds/usb_connected),)  
...
#ifneq ($(wildcard $(F4BY_ROOT)/src/systemcmds/auth),)  
#MODULES		+= systemcmds/auth
#endif
#ifneq ($(wildcard $(F4BY_ROOT)/src/modules/libtomfastmath),)  
