...
#define CCM_RAM_SIZE 64
#define FLASH_LOAD_ADDRESS 0x00000010
...
// I2C configuration
#define HAL_I2C2_SCL_AF 4
#define HAL_I2C2_CONFIG { &I2CD2, STM32_I2C_I2C2_RX_DMA_STREAM, STM32_I2C_I2C2_TX_DMA_STREAM }
#define HAL_I2C1_SCL_AF 4
#define HAL_I2C1_CONFIG { &I2CD1, STM32_I2C_I2C1_RX_DMA_STREAM, STM32_I2C_I2C1_TX_DMA_STREAM }
...
{  10, true,  0, PAL_LINE(GPIOE,  3U), EXT_MODE_GPIOE }, /* PE3 LED_RED OUTPUT */ \
{  11, true,  0, PAL_LINE(GPIOE,  2U), EXT_MODE_GPIOE }, /* PE2 LED_GREEN OUTPUT */ \
{  12, true,  0, PAL_LINE(GPIOE,  1U), EXT_MODE_GPIOE }, /* PE1 LED_BLUE OUTPUT */ \
{  13, true,  0, PAL_LINE(GPIOE,  0U), EXT_MODE_GPIOE }, /* PE0 LED_YELOW OUTPUT */ \
}
...
#define STM32_USART1_TX_DMA_CONFIG true, STM32_UART_USART1_TX_DMA_STREAM, STM32_USART1_TX_DMA_CHN
...
#ifdef STM32_TIM_TIM2_UP_DMA_STREAM
...
#define HAL_USART3_CONFIG { (BaseSequentialStream*) &SD3, false, STM32_USART3_RX_DMA_CONFIG, STM32_USART3_TX_DMA_CONFIG, 0}
#define HAL_USART2_CONFIG { (BaseSequentialStream*) &SD2, false, STM32_USART2_RX_DMA_CONFIG, STM32_USART2_TX_DMA_CONFIG, 0}
#define HAL_USART1_CONFIG { (BaseSequentialStream*) &SD1, false, STM32_USART1_RX_DMA_CONFIG, STM32_USART1_TX_DMA_CONFIG, 0}
#define HAL_UART_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART3_CONFIG,HAL_USART2_CONFIG,HAL_USART1_CONFIG
